...
export default function Course() {
  ...
  useEffect(() => {
    axios
      .get("https://vpr6lv-3000.csb.app/admin/courses/" + param.courseId, {
        headers: {
...
function GreyTopper() {
  ...
  return (
    ...
    >
      <Typography
        style={{ viewTransitionName: `heading-${course._id}`, color: "white" }}
        textAlign={"center"}
        variant="h4"
      >
        {course.title}
...
function CourseCard() {
  ...
  return (
    <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
      <Card
        style={{
          viewTransitionName: `card-${course._id}`,
          margin: 10,
          borderRadius: 20,
          marginTop: 50,
          marginLeft: 20,
        ...
        sx={{ width: 300 }}
      >
        <CardMedia sx={{ height: 170 }} image={course.imageLink} />
        <CardContent>
      ...
      <Button
        ...
        onClick={async () => {
          const res = await axios.put(
            "https://vpr6lv-3000.csb.app/admin/courses/" + form._id,
            form,
            {
              headers: {
                Authorization: "Bearer " + localStorage.getItem("adminToken"),
